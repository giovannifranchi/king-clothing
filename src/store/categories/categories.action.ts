...
export const fetchCategoriesSuccess = (categoryArray: CategoryData[]):FetchCategoriesSuccess=>createAction(CATEGORIES_ACTION_TYPES.FETCH_CATEGORIES_SUCCESS, categoryArray);

export const fetchCategoriesFailure = (error:Error):FetchCategoriesFailure=>createAction(CATEGORIES_ACTION_TYPES.FETCH_CATEGORIES_FAILED, error);
