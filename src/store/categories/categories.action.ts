...
export const fetchCategoriesSuccess = withMatcher((categoryArray: Category[]):FetchCategoriesSuccess=>createAction(CATEGORIES_ACTION_TYPES.FETCH_CATEGORIES_SUCCESS, categoryArray));
